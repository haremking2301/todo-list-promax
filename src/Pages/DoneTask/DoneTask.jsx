...
import { getDoneTasksThunk } from '../../Redux/reducers/getDoneTask';
...
function DoneTaskPage() {
  ...
  const dataDoneTasks = useSelector((state) => state.getDoneTasks.dataDoneTasks)

  return (
    <div className='containerha'>
      <Row gutter={24} justify="start">
        {dataDoneTasks.map(function (task) {
